...
void process_start()
{
    /**/ print(L"- Something In\n");
    ThreadInfo *threadInfo; efi_malloc(&threadInfo, sizeof(ThreadInfo));
...
efi_main (EFI_HANDLE ImageHandle, EFI_SYSTEM_TABLE *SystemTable)
{
    ...
    efi_call7(mpService->StartupAllAPs, mpService, process_start, true, threadRunEvent, 0, NULL, NULL);
    
    // /**/ print(L"- Starting Self\n");
    // process_start();
